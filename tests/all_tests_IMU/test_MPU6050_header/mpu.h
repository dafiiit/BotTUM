#ifndef _DAVID_MPU6050_H
#define _DAVID_MPU6050_H
...
public:
    ...
    // ... Weitere Funktionen und Methoden hier ...
    //1 
    bool getEventTemp(sensors_event_t *);
    void getSensorTemp(sensor_t *);

    //2
    bool getEventAccelerometer(sensors_event_t *);
    void getSensorAccelerometer(sensor_t *);

    //3
    bool getEventGyro(sensors_event_t *);
    void getSensorGyro(sensor_t *);
...
private:
    // Klassenvariablen hier 
    //1
    int _sensorIDTemp = 0x650;
    Adafruit_MPU6050 *_theMPU6050Temp = NULL;

    //2
    int _sensorIDAccelerometer = 0x651;
    Adafruit_MPU6050 *_theMPU6050Accelerometer = NULL;

    //3
    int _sensorIDGyro = 0x652;
    Adafruit_MPU6050 *_theMPU6050Gyro = NULL;
...
protected:
    // ... Geschützte Klassenvariablen hier ...
    //4
